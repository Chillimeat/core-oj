...
func TestServerJava(t *testing.T) {
	uaddr, err := net.ResolveUnixAddr("unix", "/var/run/judger-test.sock")
	if err != nil {
		t.Error(err)
		return
	...
	send([]byte(`{"cn":1, "tt": 6,"tw":"/home/kamiyoru/data/test/ce801d6b3f096fdfa8b63241b6d07c73","ops":0,"inp":"in.txt","soup":"ans.txt","tl":20010000000,"ml":262144,"spj":false}`))
	fmt.Println(string(receive()))
}
